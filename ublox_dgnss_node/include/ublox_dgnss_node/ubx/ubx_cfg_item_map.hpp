...
using ubx_cfg_item_map_t = std::map<ubx_key_id_t, ubx_cfg_item_t>;
...
// cfg i2cinprot
const ubx_cfg_item_t CFG_I2CINPROT_UBX = {"CFG_I2CINPROT_UBX", 0x10710001, L, 1, NA};
const ubx_cfg_item_t CFG_I2CINPROT_NMEA = {"CFG_I2CINPROT_NMEA", 0x10710002, L, 1, NA};
const ubx_cfg_item_t CFG_I2CINPROT_RTCM3X = {"CFG_I2CINPROT_RTCM3X", 0x10710004, L, 1, NA};

// cfg i2coutprot
const ubx_cfg_item_t CFG_I2COUTPROT_UBX = {"CFG_I2COUTPROT_UBX", 0x10720001, L, 1, NA};
const ubx_cfg_item_t CFG_I2COUTPROT_NMEA = {"CFG_I2COUTPROT_NMEA", 0x10720002, L, 1, NA};
const ubx_cfg_item_t CFG_I2COUTPROT_RTCM3X = {"CFG_I2COUTPROT_RTCM3X", 0x10720004, L, 1, NA};

// cfg spiinprot
const ubx_cfg_item_t CFG_SPIINPROT_UBX = {"CFG_SPIINPROT_UBX", 0x10790001, L, 1, NA};
const ubx_cfg_item_t CFG_SPIINPROT_NMEA = {"CFG_SPIINPROT_NMEA", 0x10790002, L, 1, NA};
const ubx_cfg_item_t CFG_SPIINPROT_RTCM3X = {"CFG_SPIINPROT_RTCM3X", 0x10790004, L, 1, NA};

// cfg spioutprot
const ubx_cfg_item_t CFG_SPIOUTPROT_UBX = {"CFG_SPIOUTPROT_UBX", 0x107a0001, L, 1, NA};
const ubx_cfg_item_t CFG_SPIOUTPROT_NMEA = {"CFG_SPIOUTPROT_NMEA", 0x107a0002, L, 1, NA};
const ubx_cfg_item_t CFG_SPIOUTPROT_RTCM3X = {"CFG_SPIOUTPROT_RTCM3X", 0x107a0004, L, 1, NA};
...
// cfg signal since X20P
// @exclude: F9P,F9R
const ubx_cfg_item_t CFG_SIGNAL_PLAN = {"CFG_SIGNAL_PLAN", 0x2031003a, E1, 1, NA};
enum CFG_SIGNAL_PLAN_ENUM {SP1 = 0, SP2 = 1, SP6 = 6};
const ubx_cfg_item_t CFG_SIGNAL_GPS_L5_ENA = {"CFG_SIGNAL_GPS_L5_ENA", 0x10310004, L, 1, NA};
const ubx_cfg_item_t CFG_SIGNAL_GAL_E6_ENA = {"CFG_SIGNAL_GAL_E6_ENA", 0x1031000b, L, 1, NA};
...
const ubx_cfg_item_t CFG_ODO_VELLPGAIN = {"CFG_ODO_VELLPGAIN", 0x20220031, U1, 1, NA};
...
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1074_USB =
{"CFG_MSGOUT_RTCM_3X_TYPE1074_USB", 0x20910361, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1084_UART2 =
{"CFG_MSGOUT_RTCM_3X_TYPE1084_UART2", 0x20910365, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1084_USB =
{"CFG_MSGOUT_RTCM_3X_TYPE1084_USB", 0x20910366, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1094_UART2 =
{"CFG_MSGOUT_RTCM_3X_TYPE1094_UART2", 0x2091036a, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1094_USB =
{"CFG_MSGOUT_RTCM_3X_TYPE1094_USB", 0x2091036b, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1124_UART2 =
{"CFG_MSGOUT_RTCM_3X_TYPE1124_UART2", 0x2091036f, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1124_USB =
{"CFG_MSGOUT_RTCM_3X_TYPE1124_USB", 0x20910370, U1, 0, NA};
...
// moving-base reference message (switches the receiving unit into heading mode).
// @exclude: X20P
...
ubx_cfg_item_map_t ubxKeyCfgItemMap = {
  ...
  {CFG_I2CINPROT_UBX.ubx_key_id, CFG_I2CINPROT_UBX},
  {CFG_I2CINPROT_NMEA.ubx_key_id, CFG_I2CINPROT_NMEA},
  {CFG_I2CINPROT_RTCM3X.ubx_key_id, CFG_I2CINPROT_RTCM3X},
  {CFG_I2COUTPROT_UBX.ubx_key_id, CFG_I2COUTPROT_UBX},
  {CFG_I2COUTPROT_NMEA.ubx_key_id, CFG_I2COUTPROT_NMEA},
  {CFG_I2COUTPROT_RTCM3X.ubx_key_id, CFG_I2COUTPROT_RTCM3X},
  {CFG_SPIINPROT_UBX.ubx_key_id, CFG_SPIINPROT_UBX},
  {CFG_SPIINPROT_NMEA.ubx_key_id, CFG_SPIINPROT_NMEA},
  {CFG_SPIINPROT_RTCM3X.ubx_key_id, CFG_SPIINPROT_RTCM3X},
  {CFG_SPIOUTPROT_UBX.ubx_key_id, CFG_SPIOUTPROT_UBX},
  {CFG_SPIOUTPROT_NMEA.ubx_key_id, CFG_SPIOUTPROT_NMEA},
  {CFG_SPIOUTPROT_RTCM3X.ubx_key_id, CFG_SPIOUTPROT_RTCM3X},
  ...
  {CFG_SIGNAL_GPS_L5_ENA.ubx_key_id, CFG_SIGNAL_GPS_L5_ENA},
  ...
  {CFG_SIGNAL_GAL_E6_ENA.ubx_key_id, CFG_SIGNAL_GAL_E6_ENA},
  ...
  {CFG_SIGNAL_BDS_B2A_ENA.ubx_key_id, CFG_SIGNAL_BDS_B2A_ENA},
  {CFG_SIGNAL_BDS_B3_ENA.ubx_key_id, CFG_SIGNAL_BDS_B3_ENA},
  ...
  {CFG_MSGOUT_RTCM_3X_TYPE1074_USB.ubx_key_id, CFG_MSGOUT_RTCM_3X_TYPE1074_USB},
  {CFG_MSGOUT_RTCM_3X_TYPE1084_USB.ubx_key_id, CFG_MSGOUT_RTCM_3X_TYPE1084_USB},
  {CFG_MSGOUT_RTCM_3X_TYPE1094_USB.ubx_key_id, CFG_MSGOUT_RTCM_3X_TYPE1094_USB},
  {CFG_MSGOUT_RTCM_3X_TYPE1124_USB.ubx_key_id, CFG_MSGOUT_RTCM_3X_TYPE1124_USB},
